...
export class DefaultTensorboard implements Tensorboard.ITensorboard {
  ...
  constructor(
    ...
    this._url = Private.getTensorboardInstanceUrl(
...
export namespace DefaultTensorboard {
  ...
  export function startNew(
    ...
    const data = JSON.stringify({ logdir: logdir });
    ...
    return ServerConnection.makeRequest(url, init, serverSettings)
      ...
      .then((data: Tensorboard.IModel) => {
        ...
        return new DefaultTensorboard(name, logdir, lastReload, {
          ...options,
          serverSettings
        });
      });
  ...
  export function listRunning(
    ...
    const instance_url = Private.getTensorboardInstanceRootUrl(
      settings.baseUrl
    );
...
namespace Private {
   ...
   */
  export const running: { [key: string]: DefaultTensorboard } =
    Object.create(null);
  ...
  export function getTensorboardInstanceUrl(
    baseUrl: string,
    name: string
  ): string {
